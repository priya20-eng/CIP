let main = {
  ...
  methods: {
    gamesetup: function() {
      ...
      var a={variable:"chessboard",pieces:{ b_pawn8: {
        position: '8_7',
        img: '&#9823;',
        captured: false,
        type: 'b_pawn',
      ...
      var str="\u265ac6,\u265fd6,\u265fc5,\u2658d5,\u2659e4,\u265cg4,\u2657c2,\u2654d2;";
        ...
        let rank=str[i+2];
        let f=str[i+1];
        let fn=f.charCodeAt(0)-'a'.charCodeAt(0)+1;
        let file=arr[str[i+1]-'a'+1];
        let position=fn+'_'+rank;
        ...
        a[piece]=position;
         ...
         console.log(a);
         console.log(a.pieces.b_pawn8.type);
